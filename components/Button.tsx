...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "flex items-center justify-center px-4 py-3 rounded-xl font-medium transition-all active:scale-95 disabled:opacity-50 disabled:pointer-events-none";
